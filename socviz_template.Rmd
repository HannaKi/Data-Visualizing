...
Histogrammille stat on count, eli määrä, jonka funktio laskee datasta kuvaajalle "lennosta".

```{r}
p <- ggplot(gss_sm, aes(x=bigregion))
p + geom_bar(mapping = aes(fill=bigregion))
```
Jos kuvaajaan halutaan muutujan arvojen osuudet, tulee käyttää toista geom_hist:in stat-funktiota, ..prop..:ia. Huomaa erikoinen merkintä!
...
Muuttuja saadaan summautumaan yhteen dummy-muuttujalla.
